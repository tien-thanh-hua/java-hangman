...
public class GameplayPanel extends GamePanel implements ActionListener {
    ...
    private void initDrawHangman() {
        ...
        titledBorder.setTitleFont(new Font("Consolas", Font.BOLD , Game.FONT_SIZE));
        
        pnlDrawHangman = new DrawHangmanPanel();
    ...
    private void initPlayerInfo() {
        ...
        pnlPlayerInfo = new PlayerInfoPanel();
        ...
        btnNewGame = new GameButton("Menu");
...
//            }
    ...
    public void updateLblTopic() {
        ...
        if (!(game.getQuestion() == null)) {
            if (game.getDifficulty() != "asian" && game.getDifficulty() != "hard") {
    ...
    public void btnLetterActionPerformed(char c) {
        ...
        if (game.isLevelCompleted()) {
            ...
            game.setWordIndex(game.getWordIndex() + 1);
            levelComplete();
        }
        if (game.isGameOver()) {
